...
router.delete('/user/:id', passport.authenticate('jwt', { session: false}), UserController.destroyData);
// Role
...
router.delete('/role/:id', passport.authenticate('jwt', { session: false}), RoleController.destroyData);
